...
<head>
    ...
    <title>Shift Assignment Declined</title>
    <style>
...
<body>
    <div class="header">
        <h1>Shift Assignment Declined</h1>
        <p>Action may be required to fill this shift</p>
    </div>
    ...
    <div class="content">
        ...
        <div class="alert-banner">
            ...
            <p>
                ...
                has declined the shift assignment. The shift is now open again.
            </p>
        </div>
        ...
        <div class="action-note">
            <strong>Next step:</strong> Please log in to the NexShift admin panel and assign another available worker to this shift.
        </div>
